    ...
    return (
        <main className='w-full  relative mx-auto  lg:mt-[580px] '>
            <div className='content bg-[#000000] relative'>
                <div className='image lg:w-full object-cover h-[1900px] lg:h-[760px]  '></div>
                    ...
                    <div className='lg:max-w-[1440px] w-[93%] mx-auto flex justify-center lg:w-full '>
                        <div>
                            <div className='lg:flex justify-center '>
                                <div className='mt-[752px] flex lg:flex-col flex-col lg:mt-[246px]'>
                                    ...
                                    <Image src={sakuna} alt='sakuna' className='mx-auto lg:ml-auto lg:-mr-[11px] lg:-mt-[193px] mt-[30px] close' />
                                </div>
                ...
                <Image src={cloud} alt='cloud' className='lg:-mt-[194px] -mt-[60px] ' />
            </div>
