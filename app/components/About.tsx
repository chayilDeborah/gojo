...
const About = () => {
    return (
        <main className='w-full  relative mx-auto overflow-hidden  lg:mt-[580px] '>
            <div className='content bg-[#000000] relative'>
                <div className='image lg:w-full object-cover h-[1900px] lg:h-[900px]  '  data-aos="zoom-out"></div>
                        ...
                        <div>
                            <div className='lg:flex justify-center '>
                                <div className='mt-[752px] flex lg:flex-col flex-col lg:mt-[430px]'>
                                    <h1 className='lg:text-[200px] text-[100px] leading-[90px] lg:leading-[180px] -tracking-[2%] font lg:w-[456px] text-[#D9DAD9] text-center ' data-aos="fade-out" >About Us</h1>
                                    <Image src={sakuna} alt='sakuna' className='mx-auto lg:ml-auto lg:-mr-[38px] lg:-mt-[193px] mt-[30px] close'  data-aos="zoom-in"/>
                                </div>
