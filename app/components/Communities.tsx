  ...
  return (
    ...
    <main className='w-full  relative mx-auto mt-[2150px] lg:-mt-[65px] '>
        ...
        <div className='lg:max-w-[1440px] w-[93%] mx-auto flex justify-center lg:w-full '>
            <div>
                <Image src={gojo} alt='gojo' className='mt-[50px] lg:-mt-[300px] ' />
                <h1  className='lg:text-[200px] text-[80px] leading-[90px]  -tracking-[2%] font text-[#D9DAD9] text-center lg:mt-[270px] mt-[80px] lg:mb-[110px] mb-[58px] '>Community</h1>
