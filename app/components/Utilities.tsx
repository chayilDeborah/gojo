                        ...
                        <div className='lg:mt-[140px] mt-[100px]  '>
                            ...
                            <div className='mt-[37px] grid grid-cols-1 lg:grid-cols-3 gap-[30px] lg:gap-[62px] mb-[50px] '>
                                <div className='lg:w-[369px] lg:h-[378px] w-[330px]  round '  data-aos="fade-up" data-duration="1400" >
                                    ...
                                    <div className='lg:h-[234px] bg-[#171212] pt-[21px] pl-[28px] rounded-b-[17px] '>
                                ...
                                <div className='lg:w-[369px] lg:h-[378px] w-[330px]  round '  data-aos="fade-up" data-duration="1500">
                                    ...
                                    <div className='lg:h-[234px] bg-[#171212] pt-[21px] pl-[28px] rounded-b-[17px] '>
                                        <h1 className='text-[20px] leading-[24px] -tracking-[2%] text-[#E6E7E6] font-bold '>Is Gojo Free?</h1>
                                ...
                                <div className='lg:w-[369px] lg:h-[378px] w-[330px]  round '  data-aos="fade-up" data-duration="1600">
                                    ...
                                    <div className='lg:h-[234px] bg-[#171212] pt-[21px] pl-[28px] rounded-b-[17px] '>
                                        <h1 className='text-[20px] leading-[24px] -tracking-[2%] text-[#E6E7E6] font-bold '>Is Gojo Safe?</h1>
                                        <h2 className='text-[16px] leading-[19.2px] -tracking-[2%] text-[#E6E7E6] mt-[32px] pb-[42px] mr-[10px] '>Yes, Gojo has multiple security layers in addition to WhatsApp&#39;s security measures. However, we strongly advise you to secure your private keys.
                                ...
                                <div className='lg:w-[369px] lg:h-[378px] w-[330px]  round '  data-aos="fade-up" data-duration="1700">
                                    ...
                                    <div className='lg:h-[234px] bg-[#171212] pt-[21px] pl-[28px] rounded-b-[17px] '>
                                        <h1 className='text-[20px] leading-[24px] -tracking-[2%] text-[#E6E7E6] font-bold '>How to Use Gojo Bot?</h1>
                                ...
                                <div className='lg:w-[369px] lg:h-[378px] w-[330px]  round '  data-aos="fade-up" data-duration="1800">
                                    ...
                                    <div className='lg:h-[234px] bg-[#171212] pt-[21px] pl-[28px] rounded-b-[17px] '>
                                        <h1 className='text-[20px] leading-[24px] -tracking-[2%] text-[#E6E7E6] font-bold '>When Will $GOJO Launch?</h1>
