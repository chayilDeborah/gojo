...
<main className=''>
  ...
  <div className='image5 hidden lg:block w-[900px] h-[405px]'></div>
  <div className='image6 lg:hidden block lg:w-[900px] h-[405px]'></div>
    ...
    <div className='w-full  relative mx-auto -mt-[405px] '>
      <div className='content bg-[#000000] relative'>
        ...
        <div className='image4 absolute lg:w-full object-cover absolute inset-0 mix-blend-screen z-10 h-[615px] lg:h-[600px]  '></div>
        ...
        <section className='absolute mx-auto w-full mx-auto lg:w-full top-0 left-0 right-0 flex flex-col justify-center '>
          <div className='lg:max-w-[1440px] w-[93%] flex justify-center lg:w-full mx-auto '>
            <div className='mx-auto text-white pt-[27px] '>
              ...
              <div className='mt-[10px] close relative z-20 flex-col items-center justify-center'>
